"""
Django settings for azure_auth_demo project.
...
SECRET_KEY = 'django-insecure-=7d5f9h$f1*n+0#2r1svkttpxb5i-)#34qrr)uu7d#ywc0)xax'
...
ROOT_URLCONF = 'azure_auth_demo.urls'
...
WSGI_APPLICATION = 'azure_auth_demo.wsgi.application'
